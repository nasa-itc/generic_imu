...
void Test_GENERIC_IMU_AppMain(void) {
  ...
  UT_CheckEvent_Setup(&EventTest, GENERIC_IMU_PIPE_ERR_EID,
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_IMU_PIPE_ERR_EID generated (%u)",
...
void Test_GENERIC_IMU_ProcessCommandPacket(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 0,
                "GENERIC_IMU_CMD_ERR_EID not generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  GENERIC_IMU_ProcessCommandPacket();
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_IMU_CMD_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
...
void Test_GENERIC_IMU_ProcessGroundCommand(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_IMU_CMD_NOOP_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  GENERIC_IMU_ProcessGroundCommand();
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_IMU_CMD_RESET_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
...
void Test_GENERIC_IMU_ReportHousekeeping(void) {
  ...
  UtAssert_True(MsgTimestamp ==
                    &GENERIC_IMU_AppData.HkTelemetryPkt.TlmHeader.Msg,
...
void Test_GENERIC_IMU_VerifyCmdLength(void) {
   ...
   */
  UtAssert_True(EventTest.MatchCount == 0,
                "GENERIC_IMU_LEN_ERR_EID NOT generated (%u)",
                (unsigned int)EventTest.MatchCount);
   ...
   */
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_IMU_LEN_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
 ...
 */
void Generic_imu_UT_Setup(void) { UT_ResetState(0); }
