...
#define GENERIC_IMU_DEVICE_HK_SIZE                                             \
  GENERIC_IMU_DEVICE_HK_LNGTH + GENERIC_IMU_DEVICE_HDR_TRL_LEN
...
#define GENERIC_IMU_DEVICE_AXIS_DATA_LNGTH                                     \
  sizeof(GENERIC_IMU_Device_Axis_Data_t)
#define GENERIC_IMU_DEVICE_X_DATA_SIZE                                         \
  GENERIC_IMU_DEVICE_X_DATA_LNGTH + GENERIC_IMU_DEVICE_HDR_TRL_LEN
...
#define GENERIC_IMU_DEVICE_DATA_SIZE                                           \
  GENERIC_IMU_DEVICE_DATA_LNGTH + GENERIC_IMU_DEVICE_HDR_TRL_LEN
