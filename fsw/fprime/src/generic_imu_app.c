...
void IMU_AppMain(void) {
  ...
  */
  while (CFE_ES_RunLoop(&GENERIC_IMU_AppData.RunStatus) == true) {
    ...
    */
    status =
        CFE_SB_ReceiveBuffer((CFE_SB_Buffer_t **)&GENERIC_IMU_AppData.MsgPtr,
                             GENERIC_IMU_AppData.CmdPipe, CFE_SB_PEND_FOREVER);
    ...
    */
    if (status == CFE_SUCCESS) {
      ...
      CFE_EVS_SendEvent(GENERIC_IMU_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
                        "GENERIC_IMU: SB Pipe Read Error = %d", (int)status);
      GENERIC_IMU_AppData.RunStatus = CFE_ES_RunStatus_APP_ERROR;
    }
  }
...
int32 GENERIC_IMU_AppInit(void) {
  ...
  */
  ...
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "GENERIC_IMU: Error registering for event services: 0x%08X\n",
        (unsigned int)status);
    return status;
  }
  ...
  */
  status = CFE_SB_CreatePipe(&GENERIC_IMU_AppData.CmdPipe,
                             GENERIC_IMU_PIPE_DEPTH, "IMU_CMD_PIPE");
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_IMU_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_IMU_CMD_MID),
                            GENERIC_IMU_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_IMU_REQ_HK_MID),
                            GENERIC_IMU_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
  ...
  ** telemetry that has been defined in the GENERIC_IMU_HkTelemetryPkt for this
  *app.
  */
  ...
  */
  ...
  GENERIC_IMU_AppData.Generic_imuCan.second_timeout =
      GENERIC_IMU_CFG_CAN_TIMEOUT;
  GENERIC_IMU_AppData.Generic_imuCan.microsecond_timeout =
      GENERIC_IMU_CFG_CAN_MS_TIMEOUT;
  GENERIC_IMU_AppData.Generic_imuCan.xfer_us_delay =
      GENERIC_IMU_CFG_CAN_XFER_US;
  ...
  status = CFE_EVS_SendEvent(
      GENERIC_IMU_STARTUP_INF_EID, CFE_EVS_EventType_INFORMATION,
      "GENERIC_IMU App Initialized. Version %d.%d.%d.%d",
      GENERIC_IMU_MAJOR_VERSION, GENERIC_IMU_MINOR_VERSION,
      GENERIC_IMU_REVISION, GENERIC_IMU_MISSION_REV);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "GENERIC_IMU: Error sending initialization event: 0x%08X\n",
        (unsigned int)status);
  }
  return status;
}
...
void GENERIC_IMU_ProcessCommandPacket(void) {
  ...
  /*
  ** Ground Commands with command codes fall under the GENERIC_IMU_CMD_MID
  *(Message ID)
  */
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(GENERIC_IMU_PROCESS_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
                      "GENERIC_IMU: Invalid command packet, MID = 0x%x",
...
void GENERIC_IMU_ProcessGroundCommand(void) {
  ...
  */
  case GENERIC_IMU_NOOP_CC:
    ...
    */
    if (GENERIC_IMU_VerifyCmdLength(GENERIC_IMU_AppData.MsgPtr,
                                    sizeof(GENERIC_IMU_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      /* Second, send EVS event on successful receipt ground commands*/
      CFE_EVS_SendEvent(GENERIC_IMU_CMD_NOOP_INF_EID,
  ...
  */
  case GENERIC_IMU_RESET_COUNTERS_CC:
    if (GENERIC_IMU_VerifyCmdLength(GENERIC_IMU_AppData.MsgPtr,
                                    sizeof(GENERIC_IMU_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_IMU_CMD_RESET_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_IMU_ENABLE_CC:
    if (GENERIC_IMU_VerifyCmdLength(GENERIC_IMU_AppData.MsgPtr,
                                    sizeof(GENERIC_IMU_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_IMU_CMD_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_IMU_DISABLE_CC:
    if (GENERIC_IMU_VerifyCmdLength(GENERIC_IMU_AppData.MsgPtr,
                                    sizeof(GENERIC_IMU_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_IMU_CMD_DISABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(GENERIC_IMU_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
                      "GENERIC_IMU: Invalid command code for packet, MID = "
                      "0x%x, cmdCode = 0x%x",
...
void GENERIC_IMU_ReportHousekeeping(void) {
  ...
  if (GENERIC_IMU_AppData.HkTelemetryPkt.DeviceEnabled ==
      GENERIC_IMU_DEVICE_ENABLED) {
    status = GENERIC_IMU_RequestHK(
        &GENERIC_IMU_AppData.Generic_imuCan,
        (GENERIC_IMU_Device_HK_tlm_t *)&GENERIC_IMU_AppData.HkTelemetryPkt
            .DeviceHK);
    if (status == OS_SUCCESS) {
      ...
      CFE_EVS_SendEvent(GENERIC_IMU_REQ_HK_ERR_EID, CFE_EVS_EventType_ERROR,
                        "GENERIC_IMU: Request device HK reported error %d",
                        status);
    }
  }
  ...
  CFE_SB_TransmitMsg((CFE_MSG_Message_t *)&GENERIC_IMU_AppData.HkTelemetryPkt,
                     true);
  return;
}
...
void GENERIC_IMU_ReportDeviceTelemetry(void) {
  ...
  if (GENERIC_IMU_AppData.HkTelemetryPkt.DeviceEnabled ==
      GENERIC_IMU_DEVICE_ENABLED) {
    status = GENERIC_IMU_RequestData(
        &GENERIC_IMU_AppData.Generic_imuCan,
        (GENERIC_IMU_Device_Data_tlm_t *)&GENERIC_IMU_AppData.DevicePkt
            .Generic_imu);
    if (status == OS_SUCCESS) {
      GENERIC_IMU_AppData.HkTelemetryPkt.DeviceCount++;
      /* Time stamp and publish data telemetry */
      CFE_SB_TimeStampMsg((CFE_MSG_Message_t *)&GENERIC_IMU_AppData.DevicePkt);
      CFE_SB_TransmitMsg((CFE_MSG_Message_t *)&GENERIC_IMU_AppData.DevicePkt,
                         true);
    } else {
      GENERIC_IMU_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(GENERIC_IMU_REQ_DATA_ERR_EID, CFE_EVS_EventType_ERROR,
                        "GENERIC_IMU: Request device data reported error %d",
                        status);
    }
  }
  /* Intentionally do not report errors if disabled */
...
void GENERIC_IMU_Enable(void) {
  ...
  if (GENERIC_IMU_AppData.HkTelemetryPkt.DeviceEnabled ==
    ...
    GENERIC_IMU_AppData.HkTelemetryPkt.DeviceEnabled =
        GENERIC_IMU_DEVICE_ENABLED;
    CFE_EVS_SendEvent(GENERIC_IMU_ENABLE_INF_EID, CFE_EVS_EventType_INFORMATION,
                      "GENERIC_IMU: Device enabled");
  } else {
    GENERIC_IMU_AppData.HkTelemetryPkt.DeviceErrorCount++;
...
void GENERIC_IMU_Disable(void) {
  ...
  if (GENERIC_IMU_AppData.HkTelemetryPkt.DeviceEnabled ==
    ...
    GENERIC_IMU_AppData.HkTelemetryPkt.DeviceEnabled =
        GENERIC_IMU_DEVICE_DISABLED;
    CFE_EVS_SendEvent(GENERIC_IMU_DISABLE_INF_EID,
                      CFE_EVS_EventType_INFORMATION,
...
*/
int32 GENERIC_IMU_VerifyCmdLength(CFE_MSG_Message_t *msg,
  ...
  if (expected_length == actual_length) {
    ...
    CFE_EVS_SendEvent(
        GENERIC_IMU_LEN_ERR_EID, CFE_EVS_EventType_ERROR,
