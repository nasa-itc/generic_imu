...
** This struct is defined in the `generic_imu_app.h` file with one global
*instance
** in the `.c` file.
*/
typedef struct {
  ...
  */
  GENERIC_IMU_Hk_tlm_t
      HkTelemetryPkt; /* GENERIC_IMU Housekeeping Telemetry Packet */
...
// int32 GENERIC_IMU_VerifyCmdLength(CFE_MSG_Message_t * msg, uint16
// expected_length);
