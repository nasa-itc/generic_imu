...
#define GENERIC_IMU_UART_INIT_ERR_EID         40
#define GENERIC_IMU_UART_CLOSE_ERR_EID        41
#define GENERIC_IMU_UART_READ_ERR_EID         42
#define GENERIC_IMU_UART_WRITE_ERR_EID        43
#define GENERIC_IMU_UART_TIMEOUT_ERR_EID      44
